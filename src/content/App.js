...
// import reducer from 'content/main/store';
// import { createGenerateClassName, jssPreset, StylesProvider } from '@material-ui/core/styles';
// import jssExtend from 'jss-plugin-extend';
// import rtl from 'jss-rtl';
// import { create } from 'jss';
// import { toggleExtension } from './main/store/messageSlice';
...
// 		console.log('message: check open', store.getState().App.message.isExtensionOpen);
// 		sendResponse({ isExtensionOpen: store.getState().App.message.isExtensionOpen });
// 	}
// 	if (request.message == 'TOGGLE_EXTENSION') {
// 		if (request.isExtensionOpen == false) {
// 			// store.dispatch(removeAllAds());
// 			// store.dispatch(removeAllRequestAds());
// 		}
// 		store.dispatch(toggleExtension(request.isExtensionOpen));
// 		// console.log('store.getState()', store.getState(), request.isExtensionOpen);
...
// // chrome.storage.local.get(['isExtensionOpen'], function (result) {
// // 	result.isExtensionOpen = typeof result.isExtensionOpen == 'undefined' ? true : result.isExtensionOpen;
// // 	// console.log('result.isExtensionOpen', result.isExtensionOpen);
// // 	// store.dispatch(toggleExtension(result.isExtensionOpen));
// // });
...
// 	}, [loading]);
// 	//
// 	const [isOpen, setIsOpen] = useState(store.getState().App.message.isExtensionOpen);
// 	store.subscribe(() => {
// 		isOpen != store.getState().App.message.isExtensionOpen &&
// 			setIsOpen(store.getState().App.message.isExtensionOpen);
// 	});
// 	//
